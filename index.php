...
<body>
    <div class="container">
        ...
        <form action="procesar.php" method="post" id="formReparacion">
            ...
            <input type="tel" id="telefono" name="telefono" required title="Introduce 9 dígitos" />
            ...
            <div class="accesorios">
                ...
                <input type="text" id="otrosTexto" name="otrosTexto" placeholder="Especificar otros accesorios" disabled
            ...
            <a href="registro.php" style="text-decoration: none;">
                <button type="button"
                    style="background: #0a7373; color: white; border: none; padding: 12px 25px; border-radius: 5px; cursor: pointer; font-size: 16px; margin-right: 15px;">
                    Ver Registro
                </button>
            </a>
        </form>
